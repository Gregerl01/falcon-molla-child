...
<section class="hb-intro section">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hauler-body-intro.webp" alt="Falcon Hauler Body" loading="lazy" class="img-fluid rounded">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="row">
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hauler-body-accessories-01.webp" alt="Hauler Body Accessory 1" loading="lazy" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hauler-body-accessories-02.webp" alt="Hauler Body Accessory 2" loading="lazy" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hauler-body-accessories-03.webp" alt="Hauler Body Accessory 3" loading="lazy" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hauler-body-accessories-04.webp" alt="Hauler Body Accessory 4" loading="lazy" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </div>
...
<section class="hb-cta section">
    <div class="container">
        <div class="hb-cta-wrapper surface--subtle">
            <h2>Placeholder CTA Headline for Hauler Bodies</h2>
