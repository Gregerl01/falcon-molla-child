<?php
/**
 * Custom template for Mechanics Bodies category
 * Falcon Truck Bodies
 */
...
<!-- Hero Section -->
<section class="mechanics-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
        ...
        <div class="row g-0 align-items-start">
            ...
            <div class="col-xl-6 col-lg-6 d-flex">
                <div class="feature-content-wrap">
                    ...
                    <h2>Fully Equipped for On-Site Excellence</h2>
            ...
            <div class="col-lg-6 order-lg-1">
                <div class="capabilities-content" data-aos="fade-left">
                    ...
                    <p class="capabilities-intro">
                        ...
                        to handle extreme loads, harsh environments, and years of demanding field use. Every structural element is designed
                        to work together as a unified system, delivering strength, stability, and long-term reliability where it matters most.
                    </p>
                    ...
                    <div class="capability-list">
                        ...
                        <article class="capability-item" data-aos="fade-left" data-aos-delay="100">
                            ...
                            <p>
                                ...
                                heavy-wall rectangular tube cross-members and reinforced tube structures for maximum rigidity and load stability.
                            </p>
                        </article>
                        ...
                        <article class="capability-item" data-aos="fade-left" data-aos-delay="150">
                            ...
                            <p>
                                ...
                                to fatigue in demanding job-site conditions.
                            </p>
                        </article>
                        ...
                        <article class="capability-item" data-aos="fade-left" data-aos-delay="200">
                            ...
                            <p>
                                ...
                                ensures superior chassis attachment and long-term structural integrity under heavy use.
                            </p>
                        </article>
...
<section id="product-line" class="sb-products section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                <h2 class="mb-3">Mechanics Body Line Up</h2>
