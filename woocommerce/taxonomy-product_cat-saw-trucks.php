<?php
/**
 * Custom template for Saw Trucks category
 * Falcon Truck Bodies
 */
...
<section class="st-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h1>Cut.<br>Clear.<br>Conquer.</h1>
                <p class="tagline mt-3">Falcon Saw Trucks – Purpose-Built for Tree Care and Right-of-Way Maintenance</p>
...
<section class="st-intro section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h2 class="h3 fw-bold mb-4">Placeholder Headline for Saw Truck Introduction</h2>
                <p class="lead">Placeholder description highlighting the primary benefits of Falcon Saw Trucks. Emphasize specialized storage for chainsaws, pole saws, and tree care equipment.</p>
            ...
            <div class="col-lg-6">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/saw-truck-intro.webp" alt="Falcon Saw Truck" class="img-fluid rounded">
            </div>
        </div>
    </div>
</section>
...
<section class="st-features section surface">

  <!-- Wide split wrapper (controls overall width) -->
  <div class="st-features-split max-w-1500 mx-auto">
          ...
          <div class="features-grid">
            ...
            <div class="feature-item">
              ...
              <div class="feature-content">
                ...
                <p>Placeholder description for the first standard feature included with Saw Trucks.</p>
              </div>
            </div>
...
<!-- Options Section -->
<section class="st-options section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8">
                <h5>Saw Truck Options</h5>
                <h2>Placeholder Headline for Configuration Options</h2>
                <p class="text-muted">Placeholder description explaining the available configurations, body lengths, and optional upgrades for Saw Trucks.</p>
            </div>
        </div>
...
<!-- Accessories Section -->
<div class="gradient-divider"></div>
<section class="st-accessories section surface">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h5>Placeholder Tagline for Accessories Section.</h5>
                <h2>Saw Truck Accessories</h2>
            ...
            <div class="col-lg-7">
                <div class="row">
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/saw-truck-accessories-01.webp" alt="Saw Truck Accessory 1" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/saw-truck-accessories-02.webp" alt="Saw Truck Accessory 2" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/saw-truck-accessories-03.webp" alt="Saw Truck Accessory 3" class="img-fluid rounded">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/saw-truck-accessories-04.webp" alt="Saw Truck Accessory 4" class="img-fluid rounded">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Product List -->
<section id="product-line" class="st-products section">
    <div class="container section-title" data-aos="fade-up">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                <h2 class="mb-3">Saw Truck Line Up</h2>
...
<section class="st-cta section">
    <div class="container">
        <div class="st-cta-wrapper surface--subtle">
            <h3>Placeholder CTA Headline for Saw Trucks</h3>
