<?php
/**
 * Custom template for Contractor Bodies category
 * Falcon Truck Bodies
 */
...
<section class="cb-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h1>Build.<br>Haul.<br>Deliver.</h1>
                <p class="tagline mt-3">Falcon Contractor Bodies – Engineered for Heavy Loads and Jobsite Demands</p>
...
<!-- Intro Section -->
<section class="cb-intro section">
    <div class="container">
...
<section class="cb-features section surface">

  <!-- Wide split wrapper (controls overall width) -->
  <div class="cb-features-split max-w-1500 mx-auto">
...
<div class="gradient-divider"></div>
<!-- Options Section -->
<section class="cb-options section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8">
...
<!-- Accessories Section -->
 <div class="gradient-divider"></div>
<section class="cb-accessories section surface">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
