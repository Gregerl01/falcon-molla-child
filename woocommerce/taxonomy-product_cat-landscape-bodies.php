<?php
/**
 * Custom template for Landscape Bodies category
 * Falcon Truck Bodies
 */
...
<section class="lb-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h1>Mow.<br>Haul.<br>Transform.</h1>
                <p class="tagline mt-3">Falcon Landscape Bodies – Designed for Lawn Care and Grounds Maintenance Professionals</p>
...
<!-- Intro Section -->
<section class="lb-intro section">
    <div class="container">
...
<section class="lb-features section surface">

  <!-- Wide split wrapper (controls overall width) -->
  <div class="lb-features-split max-w-1500 mx-auto">
...
<!-- Options Section -->
<section class="lb-options section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8">
...
<!-- Accessories Section -->
<div class="gradient-divider"></div>
<section class="lb-accessories section surface">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
...
<!-- Product List -->
<section id="product-line" class="lb-products section">
