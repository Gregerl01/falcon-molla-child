<?php
/**
 * Custom template for Chipper Bodies category
 * Falcon Truck Bodies
 */
...
<!-- Hero Section -->
<section class="chb-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h1>Chip.<br>Dump.<br>Dominate.</h1>
                <p class="tagline mt-3">Falcon Chipper Bodies – Purpose-Built for Tree Care and Debris Management</p>
...
<!-- Intro Section -->
<section class="chb-intro section">
    <div class="container">
...
<section class="chb-features section surface">

  <!-- Wide split wrapper (controls overall width) -->
  <div class="chb-features-split max-w-1500 mx-auto">
...
<!-- Options Section -->
<section class="chb-options section">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8">
...
<!-- Accessories Section -->
<div class="gradient-divider"></div>
<section class="chb-accessories section surface">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
...
<!-- Product List -->
<section id="product-line" class="chb-products section">
