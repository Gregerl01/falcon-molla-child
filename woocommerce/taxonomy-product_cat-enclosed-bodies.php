<?php
/**
 * Custom template for Enclosed Bodies category
 * Falcon Truck Bodies
 */
...
<!-- Hero Section -->
<section class="eb-hero section">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h1>Protect.<br>Secure.<br>Deliver.</h1>
                <p class="tagline mt-3">Falcon Enclosed Bodies – Weather-Tight Storage for Tools and Equipment</p>
...
<!-- Intro Section -->
<section class="eb-intro section">
    <div class="container">
...
<section class="eb-features section surface">

  <!-- Wide split wrapper (controls overall width) -->
  <div class="eb-features-split max-w-1500 mx-auto">
    ...
    <div class="row g-0 align-items-start">
      ...
      <div class="col-xl-6 col-lg-6 d-flex">
        <div class="feature-content-wrap">
          ...
          <h2>Built for Secure, Organized, and Reliable Performance</h2>
...
<!-- Accessories Section -->
<div class="gradient-divider"></div>
<section class="eb-accessories section surface">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <h5>Built for Security. Designed for Versatility.</h5>
